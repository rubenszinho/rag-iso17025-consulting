...
\pagestyle{fancy}
\fancyhf{}
\rhead{RAG ISO 17025 Consulting}
\lhead{\thepage}
...
\caption{Interface principal do assistente RAG. [Placeholder para screenshot da tela inicial com logo Rubrion]}
...
\caption{Screenshot: Resposta para consulta sobre procedimentos obrigatórios. [Placeholder]}
...
\caption{Screenshot: Resposta sobre ensaios interlaboratoriais. [Placeholder]}
...
\caption{Screenshot: Resposta sobre retenção de registros. [Placeholder]}
...
\subsubsection{Otimizações de Build e Deploy}

O sistema foi containerizado com otimizações significativas para deployment em nuvem:

\begin{table}[ht]
\centering
\caption{Benchmarks de build e tamanho de imagens Docker.}
\label{tab:build_metrics}
\begin{tabular}{|l|c|c|c|}
\hline
\textbf{Componente} & \textbf{1º Build} & \textbf{Builds Subsequentes} & \textbf{Melhoria} \\
\hline
API & 5-7 min & 30-45s & 87\% \\
\hline
Frontend & 4-5 min & 20-30s & 82\% \\
\hline
Tamanho imagem API & 320 MB & - & - \\
\hline
Tamanho imagem Frontend & 210 MB & - & - \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[ht]
\centering
\fbox{\includegraphics[width=0.8\textwidth]{fig/docker_build_output.png}}
\caption{Screenshot: Output de build Docker otimizado. [Placeholder]}
