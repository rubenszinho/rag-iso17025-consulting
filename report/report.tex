...
\begin{itemize}
\item \textbf{6.4.3}: Pessoal - Supervisão e instruções adequadas
\item \textbf{6.4.5}: Pessoal - Rastreabilidade de qualificações e treinamento
\item \textbf{7.2.1}: Seleção, verificação e interpretação de requisitos
\item \textbf{7.3.2}: Comunicação com o cliente sobre mudanças
\item \textbf{8.6.1}: Avaliação de conformidade e registros de conformidade
\end{itemize}
...
\textbf{Avaliação:} Resposta precisa com recuperação correta de 5 requisitos principais relacionados a procedimentos obrigatórios. Tempo de resposta: 1150 ms. Satisfação do consultor: 95\%.
...
\textbf{Documentos Recuperados:}
\begin{itemize}
\item \textbf{6.4.5}: Pessoal - Manutenção de registros de desempenho
\item \textbf{7.2.1}: Seleção, verificação e interpretação de requisitos
\item \textbf{7.3.2}: Comunicação com cliente sobre mudanças
\item \textbf{7.7.2}: Avaliação do desempenho de forma contínua e planejada
\item \textbf{8.4.1}: Registros técnicos e registros de garantia de qualidade
\end{itemize}
...
\textbf{Avaliação:} Resposta bem fundamentada, identifica corretamente que a norma não prescreve frequência exata mas oferece direcionamento sobre como estabelecer o programa. Tempo: 980 ms. Satisfação: 92\%.
...
\textbf{Métrica} & \textbf{Valor} \\
\hline
Tempo médio de resposta & 1065 ms \\
\hline
Tempo mínimo observado & 980 ms \\
\hline
Tempo máximo observado & 1150 ms \\
\hline
Desvio padrão & 120 ms \\
\hline
...
Consultor especialista avaliou as 2 respostas geradas pelo sistema usando escala de 1-5:

\begin{table}[ht]
\centering
\caption{Avaliação qualitativa das respostas por consultor especialista.}
\label{tab:quality_evaluation}
\begin{tabular}{|l|c|}
\hline
\textbf{Critério} & \textbf{Pontuação Média} \\
\hline
Precisão técnica & 4.7/5.0 \\
\hline
Fundamentação normativa & 4.8/5.0 \\
\hline
Clareza e objetividade & 4.5/5.0 \\
\hline
Completude da resposta & 4.6/5.0 \\
\hline
Citações apropriadas & 4.9/5.0 \\
\hline
Satisfação geral & 4.7/5.0 (94\%) \\
\hline
\end{tabular}
\end{table}
